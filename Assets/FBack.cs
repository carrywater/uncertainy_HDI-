...
public class FBack : MonoBehaviour
{
    public AnimationCurve xTrajectoryCurve; // Keyframes = [(0, 7), (0.5, 7), (1, 207)]
    public AnimationCurve yTrajectoryCurve; // Keyframes = [(0, 7), (0.5, 207), (1, 207)]
    public float moveSpeed = 0.02775f; // Adjust this value for speed
    public Vector3 targetCoordinates = new Vector3(207f, 207f, 0f);
