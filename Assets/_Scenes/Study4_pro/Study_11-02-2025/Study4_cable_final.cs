...
public class Study4_cable_final : BaseS
{
    ...
    //private UnityEngine.UIElements.ProgressBar progressBar;  // Reference to the ProgressBar script
    ...
    public int Interface = 1; // 1: Arrow, 2: blinker lights, 3: LandingPad, 4: Both; 6 = Progress bar
    ...
    private void Start()
    {
        ...
        //{
        //    progressBar = progressBarTransform.GetComponent<UnityEngine.UIElements.ProgressBar>();
        //     if (progressBar != null)
        //     {
    ...
    private void Return()
    {
        ...
        float elapsedTime = Time.time - pseudoRetractStartTime;
